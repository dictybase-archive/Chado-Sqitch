...
SELECT pg_catalog.has_table_privilege('phenotypeprop','select');
SELECT pg_catalog.has_column_privilege('phenotypeprop', 'phenotypeprop_id', 'select');
SELECT pg_catalog.has_column_privilege('phenotypeprop', 'phenotype_id', 'select');
SELECT pg_catalog.has_column_privilege('phenotypeprop', 'type_id', 'select');
SELECT pg_catalog.has_column_privilege('phenotypeprop', 'value', 'select');
SELECT pg_catalog.has_column_privilege('phenotypeprop', 'rank', 'select');
