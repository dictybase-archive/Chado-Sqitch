...
SELECT pg_catalog.has_table_privilege('project','select');
SELECT pg_catalog.has_column_privilege('project', 'project_id', 'select');
SELECT pg_catalog.has_column_privilege('project', 'name', 'select');
